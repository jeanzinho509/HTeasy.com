...
exports.register = async (req, res) => {
  try {
    // SECURITY FIX: Remove role from destructured body to prevent mass assignment/privilege escalation
    ...
    // Hardcode user role on registration to prevent privilege escalation
    const userRole = 'user';
