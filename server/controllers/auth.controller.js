...
exports.register = async (req, res) => {
  try {
    // SECURITY: Do not extract 'role' from req.body to prevent mass assignment/privilege escalation.
    // If we accepted role here, any user could register as an 'admin'.
    ...
    // SECURITY: Hardcode new user registrations to 'user' role.
    const userRole = 'user';
