...
exports.register = async (req, res) => {
  try {
    const { name, email, password, phone } = req.body; // 🛡️ Sentinel: Removed role to prevent mass assignment
    ...
    // 🛡️ Sentinel: Force userRole to 'user' to prevent privilege escalation via mass assignment
    const userRole = 'user';
