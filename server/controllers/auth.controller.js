...
exports.register = async (req, res) => {
  try {
    // 🛡️ SECURITY FIX: Removed 'role' from req.body to prevent privilege escalation (Mass Assignment)
    ...
    // 🛡️ SECURITY FIX: Hardcode role to 'user' for all new registrations. Admin creation should be handled via a separate, authenticated route or script.
    const userRole = 'user';
