...
exports.register = async (req, res) => {
  try {
    // 🛡️ SENTINEL: Removed 'role' from destructuring to prevent mass assignment / privilege escalation
    ...
    // 🛡️ SENTINEL: Hardcode default role to 'user'. Admin/seller roles must be assigned via separate secure processes.
    const userRole = 'user';
